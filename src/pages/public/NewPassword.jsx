...
const NewPassword = () => {
    ...
    return (
        <>
            <div>
                <h1 className="text-yellow-600 font-black text-5xl lg:text-7xl text-center">Reestablece tu contraseña y continua administrando tus <span className="text-white">clientes</span></h1>
            </div>
